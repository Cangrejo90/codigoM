...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($_GET['id'])) {
        ...
        $sql = "SELECT id, descripcion FROM servicios WHERE id = $id";
    ...
    if (isset($data['descripcion'])) {
        ...
        $sql = "INSERT INTO servicios (descripcion) VALUES ('$descripcion')";
    ...
    if (isset($data['id']) && isset($data['descripcion'])) {
        ...
        $sql = "UPDATE servicios SET descripcion = '$descripcion' WHERE id = $id";
